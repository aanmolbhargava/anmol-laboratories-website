      ...
      <div className="mx-auto max-w-7xl px-6">
        <div className="mb-16 text-center">
          ...
          <p className="mx-auto mt-5 max-w-3xl text-lg leading-8 text-gray-600">
            Discover some of our most trusted Ayurvedic formulations, carefully
            developed to support everyday wellness.
          </p>
        </div>
              ...
              <div className="mt-10 grid gap-5">
                {product.benefits.slice(0, 4).map((benefit) => (
                  <div key={benefit} className="flex items-center gap-3">
                    <HiCheckCircle size={24} className="text-green-700" />
        ...
        <div className="mt-16 flex flex-col items-center gap-8">
          ...
          <div className="flex items-center gap-5">
            <button
              onClick={() =>
                setIndex(index === 0 ? bestSellers.length - 1 : index - 1)
              }
            ...
            <button
              onClick={() => setIndex((index + 1) % bestSellers.length)}
              className="rounded-full bg-white p-4 shadow-lg transition-all duration-300 hover:-translate-y-1 hover:bg-green-700 hover:text-white"
            >
