            ...
            <div className="sticky top-28">
              ...
              <div className="mt-4 flex items-center gap-3">
                ...
                <span className="text-gray-500">
                  Trusted Herbal Formulation
                </span>
              </div>

              <div className="mt-6 rounded-3xl border border-green-200 bg-gradient-to-r from-green-50 via-white to-green-50 p-7 shadow-sm">
              ...
              <div className="mt-14">
                ...
                <div className="grid gap-6 md:grid-cols-3">
                  {product.ingredients.map((item) => (
                    <div
                      key={item}
                      className="group rounded-3xl border border-green-100 bg-white p-7 shadow-sm transition-all duration-300 hover:-translate-y-2 hover:shadow-xl"
                    >
                      <div className="mb-5 flex h-16 w-16 items-center justify-center rounded-2xl bg-green-100 text-4xl">
                        🌿
                      </div>
                      ...
                      <p className="mt-3 leading-7 text-gray-500">
                        Traditionally used in Ayurvedic formulations to support
                        holistic wellness.
                      </p>
                    </div>
                  ))}
              ...
              <div className="mt-10 space-y-4 lg:sticky lg:top-28">
                {/* <Button
                ...
                <div className="grid gap-5 md:grid-cols-2">
                  <div className="rounded-3xl border border-green-100 bg-green-50 p-6">
                    ...
                    <p className="text-gray-600 leading-7">
                      Prepared using carefully selected herbs following
                  ...
                  <div className="rounded-3xl border border-blue-100 bg-blue-50 p-6">
                    ...
                    <p className="text-gray-600 leading-7">
                      Manufactured in a GMP-compliant facility with strict
                      quality control.
                    </p>
                  </div>
