            ...
            {currentUser ? (
              <div className="relative">
                <button
                  ...
                  className="flex items-center gap-3 rounded-full border border-gray-200 bg-white px-5 py-3 hover:border-green-600 hover:shadow-md"
                >
                  <HiUserCircle className="text-3xl text-green-700" />
                ...
                <AnimatePresence>
                  {profileOpen && (
                    <motion.div
                      ...
                      className="absolute right-0 mt-3 w-60 overflow-hidden rounded-2xl border bg-white shadow-2xl"
                    >
                      <Link
                        to="/profile"
              ...
              <Link
                to="/login"
                className="rounded-full border border-green-700 px-6 py-3 font-semibold text-green-700 hover:bg-green-700 hover:text-white transition"
              >
                Sign In
              </Link>
            )}
      ...
      >
        ...
        >
          <div className="mb-10 flex items-center justify-between">
            <img src="/logo/logo-icon.png" className="h-12" alt="" />
